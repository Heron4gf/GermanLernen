<!-- Shared between Daily Study and Review — receives a card prop -->
<template>
  <div>
    <!-- skeleton -->
    <div v-if="loading" class="page-header">
      <div class="skeleton skeleton-line w-40" style="height:2rem;margin-bottom:var(--space-2)"></div>
      <div class="skeleton skeleton-line w-60" style="height:1rem"></div>
    </div>
    ...
    <template v-else-if="card">
      <div class="page-header">
        <div style="display:flex;align-items:baseline;gap:var(--space-3);flex-wrap:wrap;margin-bottom:var(--space-5)">
    ...
    <div v-else class="empty-state">
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
      <h3>No card yet</h3>
